function loadBimServerApi(address, notifier, version, callback) {
    requirejs.config({
        baseUrl: address + "/js",
        urlArgs: "bust=" + version
    });

    requirejs(["bimserverapi_BimServerApi", "bimserverapi_BimServerApiPromise", "bimserverapi_Model"], function(BimServerApi, BimServerApiPromise) {
